...
local Status = DevAbs:sismember(Engineer2..'Abs:ManagerAll:',msg.sender_user_id_) 
...
local Status = DevAbs:sismember(Engineer2..'Abs:AdminAll:',msg.sender_user_id_) 
...
------ Vip Member All ------
function VipAll(msg) 
local Status = DevAbs:sismember(Engineer2..'Abs:VipAll:',msg.sender_user_id_) 
...
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(167304135) then EngineerSource = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(Engineer2) then EngineerSource = 'البوت' elseif SudoId(user_id) then EngineerSource = 'المطور الاساسي' elseif DevAbs:sismember(Engineer2..'Abs:SecondSudo:', user_id) then EngineerSource = 'المطور الثانوي' elseif DevAbs:sismember(Engineer2..'Abs:SudoBot:', user_id) then EngineerSource = DevAbs:get(Engineer2.."Abs:SudoBot:Rd"..chat_id) or 'المطور' elseif DevAbs:sismember(Engineer2..'Abs:ManagerAll:', user_id) then EngineerSource = DevAbs:get(Engineer2.."Abs:Managers:Rd"..chat_id) or 'المدير العام' elseif DevAbs:sismember(Engineer2..'Abs:AdminAll:', user_id) then EngineerSource = DevAbs:get(Engineer2.."Abs:Admins:Rd"..chat_id) or 'الادمن العام' elseif DevAbs:sismember(Engineer2..'Abs:VipAll:', user_id) then EngineerSource = DevAbs:get(Engineer2.."Abs:VipMem:Rd"..chat_id) or 'المميز العام' elseif DevAbs:sismember(Engineer2..'Abs:AbsConstructor:'..chat_id, user_id) then EngineerSource = 'المالك' elseif DevAbs:sismember(Engineer2..'Abs:BasicConstructor:'..chat_id, user_id) then EngineerSource = DevAbs:get(Engineer2.."Abs:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevAbs:sismember(Engineer2..'Abs:Constructor:'..chat_id, user_id) then EngineerSource = DevAbs:get(Engineer2.."Abs:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevAbs:sismember(Engineer2..'Abs:Managers:'..chat_id, user_id) then EngineerSource = DevAbs:get(Engineer2.."Abs:Managers:Rd"..chat_id) or 'المدير' elseif DevAbs:sismember(Engineer2..'Abs:Admins:'..chat_id, user_id) then EngineerSource = DevAbs:get(Engineer2.."Abs:Admins:Rd"..chat_id) or 'الادمن' elseif DevAbs:sismember(Engineer2..'Abs:VipMem:'..chat_id, user_id) then  EngineerSource = DevAbs:get(Engineer2.."Abs:VipMem:Rd"..chat_id) or 'المميز' elseif DevAbs:sismember(Engineer2..'Abs:Cleaner:'..chat_id, user_id) then  EngineerSource = DevAbs:get(Engineer2.."Abs:Cleaner:Rd"..chat_id) or 'المنظف' else EngineerSource = DevAbs:get(Engineer2.."Abs:mem:Rd"..chat_id) or 'العضو' end return EngineerSource end
--     Source Engineer2     --
...
var = true  
elseif DevAbs:sismember(Engineer2..'Abs:ManagerAll:', user_id) then
var = true  
elseif DevAbs:sismember(Engineer2..'Abs:AdminAll:', user_id) then
var = true  
elseif DevAbs:sismember(Engineer2..'Abs:VipAll:', user_id) then
var = true  
...
DevAbs:del(Engineer2..'Abs:Text:GpTexts'..Abbs..data.chat_id_)
DevAbs:srem(Engineer2..'Abs:Manager:GpRedod'..data.chat_id_,Abbs)
end
if DataText and DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local Abbs = DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)')
local List = DevAbs:smembers(Engineer2..'Abs:Text:GpTexts'..Abbs..data.chat_id_)
...
if text and text:match('^'..(DevAbs:get(Engineer2..'Abs:NameBot') or "انجنير")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevAbs:get(Engineer2..'Abs:NameBot') or "انجنير")..' ','')
end
...
if DevAbs:sismember(Engineer2.."Coomds"..msg.chat_id_,DEV_ABBAS) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrabs = DevAbs:get(Engineer2.."Comd:New:rt:Abs:"..DEV_ABBAS..msg.chat_id_)
...
DevAbs:set(Engineer2.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ABBAS) 
...
tdcli_function({ID="GetUser",user_id_=Engineer2},function(arg,dp) 
...
local EngineerSource = '⌁︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌁︙تم تفعيل التواصل بنجاح'
...
local EngineerSource =  DevAbs:smembers(Engineer2..'Abs:Text:GpTexts'..text..msg.chat_id_)
...
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = Engineer2,offset_ = 0,limit_ = 1},function(extra,abbas,success) 
...
if DevAbs:get(Engineer2.."Abs:Photo:BotWelcome") then AbsPhoto = DevAbs:get(Engineer2.."Abs:Photo:BotWelcome") elseif abbas.photos_[0] then AbsPhoto = abbas.photos_[0].sizes_[1].photo_.persistent_id_ else AbsPhoto = nil end 
...
if DevAbs:get('EngineerSource:'..Engineer2.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevAbs:del('EngineerSource:'..Engineer2..'id:user'..msg.chat_id_)  
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء الامر', 1, 'md')
DevAbs:del('EngineerSource:'..Engineer2.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevAbs:del('EngineerSource:'..Engineer2.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevAbs:get('EngineerSource:'..Engineer2..'id:user'..msg.chat_id_)  
...
if text and Constructor(msg) then 
if DevAbs:get('EngineerSource:'..Engineer2.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevAbs:del('EngineerSource:'..Engineer2..'ids:user'..msg.chat_id_)  
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء الامر', 1, 'md')
DevAbs:del('EngineerSource:'..Engineer2.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevAbs:del('EngineerSource:'..Engineer2.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevAbs:get('EngineerSource:'..Engineer2..'ids:user'..msg.chat_id_)  
...
local BotName = (DevAbs:get(Engineer2.."Abs:NameBot") or 'انجنير')
...
--     Source Engineer2     --
if text == "الرابط" then
if not DevAbs:get(Engineer2.."Abs:Lock:GpLinks"..msg.chat_id_) then 
if DevAbs:get(Engineer2.."Abs:Groups:Links"..msg.chat_id_) then
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌁︙𝒈𝒓𝒐𝒖𝒑 𝒍𝒊𝒏𝒌 ↬ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"..DevAbs:get(Engineer2.."Abs:Groups:Links"..msg.chat_id_), 1, "html")
else 
...
Dev_Abs(msg.chat_id_, msg.id_, 1, EngineerSource[math.random(#EngineerSource)] , 1, 'html') 
return false
end
...
if text and text == (DevAbs:get(Engineer2..'Abs:NameBot') or 'انجنير') then 
NameBot = (DevAbs:get(Engineer2..'Abs:NameBot') or 'انجنير')
...
if DevAbs:get(Engineer2.."Abs:Left:Bot"..Engineer2) and not SecondSudo(msg) then
...
ChatLeave(msg.chat_id_, Engineer2)
DevAbs:srem(Engineer2.."Abs:Groups",msg.chat_id_)
end
--     Source Engineer2     --
...
function EngineerSource(extra,result,success)
if DevAbs:get(Engineer2.."Abs:Send:Bot"..Engineer2) and not SecondSudo(msg) then 
...
⌁︙[Developer](https://t.me/BlackBirdd)
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
]]
...
Dev_Abs(msg.chat_id_, result.id_, 1,''..EngineerSource[math.random(#EngineerSource)], 1, 'html') 
else  
...
Dev_Abs(msg.chat_id_, result.id_, 1,''..EngineerSource[math.random(#EngineerSource)], 1, 'md') 
end 
...
if DevAbs:sismember(Engineer2..'Abs:ManagerAll:',result.sender_user_id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if DevAbs:sismember(Engineer2..'Abs:AdminAll:',result.sender_user_id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if DevAbs:sismember(Engineer2..'Abs:VipAll:',result.sender_user_id_) then
...
sudobot = 'المطورين • ' else sudobot = '' end
if DevAbs:sismember(Engineer2..'Abs:ManagerAll:',result.id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if DevAbs:sismember(Engineer2..'Abs:AdminAll:',result.id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if DevAbs:sismember(Engineer2..'Abs:VipAll:',result.id_) then
vpall = 'المميزين العامين • ' else vpall = '' end
...
DevAbs:srem(Engineer2..'Abs:ManagerAll:', result.id_)
DevAbs:srem(Engineer2..'Abs:AdminAll:', result.id_)
DevAbs:srem(Engineer2..'Abs:VipAll:', result.id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAbs:sadd(Engineer2..'Abs:ManagerAll:',result.id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAbs:sadd(Engineer2..'Abs:AdminAll:',result.id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAbs:sadd(Engineer2..'Abs:VipAll:',result.id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAbs:sadd(Engineer2..'Abs:AbsConstructor:'..msg.chat_id_,result.id_)
...
DevAbs:srem(Engineer2..'Abs:AbsConstructor:'..msg.chat_id_,result.sender_user_id_)
...
DevAbs:srem(Engineer2..'Abs:AbsConstructor:'..msg.chat_id_,result.id_)
...
DevAbs:srem(Engineer2..'Abs:AbsConstructor:'..msg.chat_id_,user)
...
if not Constructor(msg) and DevAbs:get(Engineer2.."Abs:Lock:MuteTked"..msg.chat_id_) then 
...
if DevAbs:sismember(Engineer2..'Abs:SecondSudo:',result.sender_user_id_) and not Sudo(msg) then
...
if DevAbs:sismember(Engineer2..'Abs:SecondSudo:',result.id_) and not Sudo(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌁︙*لاتستطيع حظر المطور الثانوي*", 1, 'md')
return false 
end
if result.id_ then
...
if DevAbs:sismember(Engineer2..'Abs:SecondSudo:',user) and not Sudo(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌁︙*لاتستطيع حظر المطور الثانوي*", 1, 'md')
return false 
end
ChatKick(msg.chat_id_, user)
...
DevAbs:set('EngineerSource:'..Engineer2..'id:user'..msg.chat_id_,TXT)  
DevAbs:setex('EngineerSource:'..Engineer2.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevAbs:set('EngineerSource:'..Engineer2..'ids:user'..msg.chat_id_,TXT)  
DevAbs:setex('EngineerSource:'..Engineer2.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
if DevAbs:get(Engineer2..'Abs:Lock:Clean'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ then if msg.reply_to_message_id_ ~= 0 then DevAbs:sadd(Engineer2.."Abs:cleaner"..msg.chat_id_, msg.id_) else DevAbs:sadd(Engineer2.."Abs:cleaner"..msg.chat_id_, msg.id_) end end end
...
local List = DevAbs:smembers(Engineer2..'Abs:AbsConstructor:'..msg.chat_id_)
text = "⌁︙قائمة المالكين ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local username = DevAbs:get(Engineer2..'Save:UserName'..v)
if username then
...
local List = DevAbs:smembers(Engineer2..'Abs:ManagerAll:')
...
local List = DevAbs:smembers(Engineer2..'Abs:VipAll:')
...
DevAbs:set("Engineer2:New:id:"..Engineer2..msg.sender_user_id_,'EngineerSource')
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙رجائا اتبع التعليمات للتعيين \n⌁︙لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه ↫ ⤈\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉', 1, 'md')
DevAbs:set("Engineer2:New:id:"..Engineer2..msg.chat_id_..msg.sender_user_id_,'EngineerSource')
return "EngineerSource"
end
...
if msg and DevAbs:get(Engineer2..'Abs:Lock:Clean'..msg.chat_id_) then
...
if DevAbs:scard(Engineer2.."Abs:cleaner"..msg.chat_id_) >= tonumber(CleanNum) then 
local List = DevAbs:smembers(Engineer2.."Abs:cleaner"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
...
DevAbs:del(Engineer2..'Abs:AdminAll:')
end
...
DevAbs:del(Engineer2..'Abs:VipAll:')
end
...
DevAbs:del(Engineer2..'Abs:ManagerAll:')
end
if txts[2] == 'المالكين' or txtss[2] == 'المالكين' then
DevAbs:del(Engineer2..'Abs:AbsConstructor:'..msg.chat_id_)
...
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and DevAbs:get(Engineer2..'HataNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and DevAbs:get(Engineer2..'RjolaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and DevAbs:get(Engineer2..'AnothaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and DevAbs:get(Engineer2..'StupidNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
{{text = '⌁ Engineer2 TeAM .',url="t.me/ba8lawa"}},
}
...
if text == "الروابط" then if DevAbs:get(Engineer2..'Abs:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end local EngineerSource = "\n" .."⌁︙الروابط ↫ "..mute_links.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if DevAbs:get(Engineer2..'Abs:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحه' end local EngineerSource = "\n" .."⌁︙المعرف ↫ "..lock_tag.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "المتحركه" or text == "الملصقات المتحركه" then if DevAbs:get(Engineer2..'Abs:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحه' end local EngineerSource = "\n" .."⌁︙المتحركه ↫ "..mute_gifs.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الملصقات" then if DevAbs:get(Engineer2..'Abs:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحه' end local EngineerSource = "\n" .."⌁︙الملصقات ↫ "..lock_sticker.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الصور" then if DevAbs:get(Engineer2..'Abs:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحه' end local EngineerSource = "\n" .."⌁︙الصور ↫ "..mute_photo.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if DevAbs:get(Engineer2..'Abs:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local EngineerSource = "\n" .."⌁︙الفيديو ↫ "..mute_video.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الاونلاين" then if DevAbs:get(Engineer2..'Abs:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفل' else mute_in = 'مفتوح' end local EngineerSource = "\n" .."⌁︙الاونلاين ↫ "..mute_in.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الدردشه" then if DevAbs:get(Engineer2..'Abs:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local EngineerSource = "\n" .."⌁︙الدردشه ↫ "..mute_text.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "التوجيه" or text == "اعاده التوجيه" then if DevAbs:get(Engineer2..'Abs:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفل' else lock_forward = 'مفتوح' end local EngineerSource = "\n" .."⌁︙التوجيه ↫ "..lock_forward.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الاغاني" then if DevAbs:get(Engineer2..'Abs:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحه' end local EngineerSource = "\n" .."⌁︙الاغاني ↫ "..mute_music.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الصوت" or text == "الصوتيات" then if DevAbs:get(Engineer2..'Abs:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفول' else mute_voice = 'مفتوح' end local EngineerSource = "\n" .."⌁︙الصوت ↫ "..mute_voice.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الجهات" or text == "جهات الاتصال" then if DevAbs:get(Engineer2..'Abs:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local EngineerSource = "\n" .."⌁︙الجهات ↫ "..lock_contact.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الماركداون" then if DevAbs:get(Engineer2..'Abs:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local EngineerSource = "\n" .."⌁︙الماركداون ↫ "..markdown.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الهاشتاك" then if DevAbs:get(Engineer2..'Abs:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local EngineerSource = "\n" .."⌁︙الهاشتاك ↫ "..lock_htag.."\n"Dev_Abs(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "التعديل" then if DevAbs:get(Engineer2..'Abs:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفل' else mute_edit = 'مفتوح' end local EngineerSource = "\n" .."⌁︙التعديل ↫ "..mute_edit.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "التثبيت" then if DevAbs:get(Engineer2..'Abs:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفل' else lock_pin = 'مفتوح' end local EngineerSource = "\n" .."⌁︙التثبيت ↫ "..lock_pin.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الاشعارات" then if DevAbs:get(Engineer2..'Abs:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحه' end local EngineerSource = "\n" .."⌁︙الاشعارات ↫ "..lock_tgservice.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الكلايش" then if DevAbs:get(Engineer2..'Abs:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحه' end local EngineerSource = "\n" .."⌁︙الكلايش ↫ "..lock_spam.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الدخول" then if DevAbs:get(Engineer2..'Abs:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفول' else lock_Join = 'مفتوح' end local EngineerSource = "\n" .."⌁︙الدخول ↫ "..lock_Join.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الشبكات" then if DevAbs:get(Engineer2..'Abs:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحه' end local EngineerSource = "\n" .."⌁︙الشبكات ↫ "..lock_wp.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "المواقع" then if DevAbs:get(Engineer2..'Abs:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحه' end local EngineerSource = "\n" .."⌁︙المواقع ↫ "..lock_location.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "العربيه" then if DevAbs:get(Engineer2..'Abs:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local EngineerSource = "\n" .."⌁︙العربيه ↫ "..lock_arabic.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الانكليزيه" then if DevAbs:get(Engineer2..'Abs:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local EngineerSource = "\n" .."⌁︙الانكليزيه ↫ "..lock_english.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الكفر" then if DevAbs:get(Engineer2..'Abs:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local EngineerSource = "\n" .."⌁︙الكفر ↫ "..lock_kaf.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الفشار" then if DevAbs:get(Engineer2..'Abs:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local EngineerSource = "\n" .."⌁︙الفشار ↫ "..lock_fshar.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الطائفيه" then if DevAbs:get(Engineer2..'Abs:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local EngineerSource = "\n" .."⌁︙الطائفيه ↫ "..lock_taf.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
end
--     Source Engineer2     --
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
DevAbs:del(Engineer2..'Abs:Lock:Stupid'..msg.chat_id_)
end
if text == 'تعطيل اوامر التحشيش' and Manager(msg) and ChCheck(msg) then 
local EngineerSource = '⌁︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌁︙تم تعطيل اوامر التحشيش'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
DevAbs:set(Engineer2..'Abs:Lock:Stupid'..msg.chat_id_,true)
end
--     Source Engineer2     --
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './Engineer2.lua', '⌁︙نسخة ملف سورس انجنير',dl_cb, nil)
end end
--     Source Engineer2     --
...
local List = DevAbs:smembers(Engineer2..'Abs:Manager:GpRed'..msg.chat_id_)
if #List == 0 then
...
local List = DevAbs:smembers(Engineer2.."Abs:Sudo:AllRed")
if #List == 0 then
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌁︙لا توجد ردود مضافه" ,  1, "md")
return false
end
...
return false end
if text and text:match("^(.*)$") then
local EngineerSource =  DevAbs:get(Engineer2..'Abs:Help0'..msg.sender_user_id_)
...
return false end
if text and text:match("^(.*)$") then
local EngineerSource =  DevAbs:get(Engineer2..'Abs:Help01'..msg.sender_user_id_)
if EngineerSource == 'msg' then 
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local EngineerSource =  DevAbs:get(Engineer2..'Abs:Help21'..msg.sender_user_id_)
if EngineerSource == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local EngineerSource =  DevAbs:get(Engineer2..'Abs:Help31'..msg.sender_user_id_)
if EngineerSource == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local EngineerSource =  DevAbs:get(Engineer2..'Abs:Help41'..msg.sender_user_id_)
if EngineerSource == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local EngineerSource =  DevAbs:get(Engineer2..'Abs:Help51'..msg.sender_user_id_)
if EngineerSource == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local EngineerSource =  DevAbs:get(Engineer2..'Abs:Help61'..msg.sender_user_id_)
if EngineerSource == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙Channel ↬ [@ba8lawa]', 1, 'md')    
end 
--     Source Engineer2     --
...
if DevAbs:get(Engineer2..'Abs:Lock:EditMsgs'..msg.chat_id_) and not Text and not BasicConstructor(result) then
