...
install() {
echo -e "\033[0;36m"
echo -e "~ Welcome To Source Engineer2 - اهلا بك في سورس ديف انجنير ~"
...
echo -e "|-------------------------------------------|"
echo -e "|This Source Was Developed By (ABS) @BlackBirdd.|"
echo -e "|  This Is The Source Channel @ba8lawa .   |"
echo -e "|               - Engineer2 -                 |"
echo -e "---------------------------------------------"
echo -e "\033[0m"
